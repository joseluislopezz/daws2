                             ...
                             <li class="nav-item start ">
                                ...
                                <li class="nav-item start ">
                                  ...
                                  <li class="nav-item start ">
                                    <a href="#" class="nav-link nav-toggle">
                                        ...
                                        <span class="title">Movimientos Saldo</span>
                                        <span class="selected"></span>
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="sub-menu">
                                          ...
                                          <li class="nav-item start ">
                                            <a href="?admin=ingresos" class="nav-link ">
                                                <i class="fa fa-search-plus"></i>
                                                <span class="title">Ingresos Saldo </span>
                                ...
                                <li class="nav-item start ">
                                    <a href="#" class="nav-link nav-toggle">
                                        ...
                                        <span class="title">Configuaracion</span>
                                        <span class="selected"></span>
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="sub-menu">
                                        <li class="nav-item start ">
                                            <a href="?admin=plataformas" class="nav-link ">
                                                <i class="fa fa-search-plus"></i>
                                                <span class="title">Plataformas de pagos</span>
