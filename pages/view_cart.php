...
if(isset($_SESSION["products"]) && count($_SESSION["products"])>0){
	$total 			= 0;
	$list_tax 		= '';
	foreach($_SESSION["products"] as $product){ //imprime cada artículo, cantidad y precio
		...
		$total 			= ($total + $subtotal); // total precio
	}
 $producto = $cart_box;
                        ...
                        <div class="row">
                            <div class="col-xs-4">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><strong>DUI: </strong> <?php echo   $cilog=$_SESSION['c3_ci']; ?>  </li>
